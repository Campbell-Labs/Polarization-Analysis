classdef ArtificialSubject < Subject
    ...
    methods
        function subject = ArtificialSubject(subjectNumber, existingSubjectNumbers, toTrialPath, projectPath, importDir, userName, toTrialFilename)
            if nargin > 0
                ...
                if ~cancel
                    ...
                    subject = ArtificialSubject.empty;
                end
            end
        end
